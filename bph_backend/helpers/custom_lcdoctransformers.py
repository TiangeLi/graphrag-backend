...
class _DocumentWithState(Document):
    ...
    def to_document(self) -> Document:
        ...
        return Document(page_content=self.page_content, metadata=self.metadata, id=self.id)
    ...
    def from_document(cls, doc: Document) -> "_DocumentWithState":
        ...
        if isinstance(doc, cls):
            return doc
        return cls(page_content=doc.page_content, metadata=doc.metadata, id=doc.id)
